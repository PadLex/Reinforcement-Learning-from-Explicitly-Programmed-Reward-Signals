...
#SBATCH --job-name=main_experiment_seed_3
#SBATCH --mail-type=BEGIN,END
#SBATCH --mail-user=gdrtodd@nyu.edu
#SBATCH --output=./slurm_outputs/main_experiment_seed_3_%j.out
...
python evolution.py --model LudiiLMs/code-llama-13b-fitm-mask-heldout-1-epoch --fitness_evaluation_strategy uct \
    ...
    --save_dir ./exp_outputs/main_experiment_seed_3 --num_threads 6 --overwrite --add_current_date --spin_gpu \
    --seed 3
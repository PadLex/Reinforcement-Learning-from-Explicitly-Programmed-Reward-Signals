...
ENFORCE_SAME_LINE_TOKENS = ["if", "then", "from", "to", "is", "count", "all", ":", "=", "+", "-"]
...
def _extract_parentheticals(game: str):
    ...
    we return the prefix, suffix, actual substring, and depth
    '''
...
if __name__ == '__main__':
    ...
    print(indent_game(pretty_format_single_line_game(game)))